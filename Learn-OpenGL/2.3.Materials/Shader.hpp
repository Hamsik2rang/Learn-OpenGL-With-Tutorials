...
public:
	...
	void setValue(const std::string& name, float x, float y, float z) { glUniform3f(glGetUniformLocation(_id, name.c_str()), x, y, z); }
	void setValue(const std::string& name, glm::vec3 vec) { glUniform3fv(glGetUniformLocation(_id, name.c_str()), 1, &vec[0]); }
